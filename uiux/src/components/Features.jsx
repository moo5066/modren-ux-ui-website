...
const features = [
  ...
  },
  {
    ...
    description: "Automatically generate tests to ensure your code is bug-free.",
  ...
  },
  {
    ...
    description: "Identify and fix issues faster with AI-driven debugging tools.",
    codeSnippet: `// Fix suggested by AI
...
{features.map((feature,key)=>(
    <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 lg:gap-12${feature.imgPostion === "right" ? "lg:flex-row-reverse":""}`}>
        ...
        <div className='flex-1 w-full'>
            ...
            <div className='relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden 
            group-hover:border-2 group-hover:border-blue-600/50 transition-all duration-300'>
                {/* id interface */}
